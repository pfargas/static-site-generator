...
def generate_pages_recursive(dir_path_content, template_path, dest_dir_path):
    ...
    for item in os.listdir(full_path):
        ...
        if not os.path.isfile(curr_item_path_content):
            ...
            generate_pages_recursive(curr_item_path_content, template_path, curr_dest_path_content)
        else:
            generate_page(curr_item_path_content, template_path, curr_dest_path_content)